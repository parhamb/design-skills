...
name: ux-forms
description: >
  UX checklist and best practices for form design. Covers input types, inline
  validation, keyboard behavior, autofill, password handling, and multi-step
  flows. Use when designing or reviewing any form, sign-up flow, checkout, or
  data-entry screen.
---
...
| No repeated input | Pre-fill known data from the existing account. Never ask twice. |
