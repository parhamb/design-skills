...
name: ux-content
description: >
  UX checklist and best practices for content strategy and UX writing. Covers
  plain language, microcopy, labeling, read/unread states, localization, and
  content freshness. Use when writing or reviewing UI copy, error messages,
  empty states, tooltips, onboarding text, or any in-product content.
---
...
| Empty state headline | Empathetic and forward-looking |
